...
@Configuration
@EnableWebSecurity
@ImportRuntimeHints(SecurityConfiguration.Saml2RuntimeHints.class)
public class SecurityConfiguration {
	...
	static class Saml2RuntimeHints implements RuntimeHintsRegistrar {

		@Override
		public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
			hints.resources().registerPattern("credentials/rp-private.key").registerPattern("credentials/rp-certificate.crt");
		}
